...
char ssid[] = "ESP_TEST";                           // WiFi Router ssid
char pass[] = "499f1ea813a3af635d84208a4d2d1b9a";             // WiFi Router password


/****** MQTT Settings ********************************************************/

//const char* mqtt_server = "192.168.10.4";      // MQTT Server (broker) address


/****** Additional Settings **************************************************/

#define LANGUAGE 'EN'               //check translation.h for available languages. Currently EN/DE/FR/IT/PL/RO/SP
